...
5. When speaking to the refuser, if they now give consent, you’ll need to go through the 'Get consent response' flow over the phone (see 'Recording verbal consent from a parent before a session starts', above).
